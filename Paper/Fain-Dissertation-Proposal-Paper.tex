...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{Virus_Replication_large.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{cell2cell.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{Illu_conducting_passages.pdf}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=0.8\linewidth]{CellPhotoA1.pdf}
        \caption{}
        \label{fig:A1}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=0.8\linewidth]{CellPhotoA2.pdf}
        \caption{}
        \label{fig:A2}
    \end{subfigure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{MOI_-30_CellToCell_CellFree_ViralTitter.pdf}
...
\begin{figure}[h]
    \centering
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=1.0\linewidth]{plaques.pdf}
        \caption{}
        \label{fig:ActualPlaques}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=1.0\linewidth]{cell145.png}
        \caption{}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\linewidth]{-50_TimeOfPeakHist.pdf}
...
\begin{figure}[h]
    \centering
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=\linewidth]{EclipseCells.pdf}
        \caption{}
        \label{fig:Dish}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
        \includegraphics[width=\linewidth]{ZoomEclipseCells.pdf}
        \caption{}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{VirusVsTime.png}
